...
{
    public static ParseResult parserTemplateTest(String src, String path){
        ...
        System.out.println("fullmatch ? : " + result.fullMatch);
        return result;
    }
    public static Reactor semanticTemplateTest(ParseResult result){
